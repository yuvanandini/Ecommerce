                            ...
                            <div className="col-12">
                                <div>
                                    ...
                                    <ul className="list-unstyled">
                                        ...
                                        <li>
                                            <a href="#" className={`btn ${selectedCategory === "Green_Packaging" ? "btn-secondary" : ""} ${selectedCategory === "Green_Packaging" ? "selected" : ""}`} onClick={() => setSelectedCategory("Green_Packaging")}>Green Packaging</a>
                                        </li>
                                        {/* <li>
                                            <a href="#" className={`btn ${selectedCategory === "Green_Packaging" ? "btn-secondary" : ""} ${selectedCategory === "Green_Packaging" ? "selected" : ""}`} onClick={() => setSelectedCategory("Green_Packaging")}>Essential Oils</a>
                                        </li>
                                        <li>
                                            <a href="#" className={`btn ${selectedCategory === "Green_Packaging" ? "btn-secondary" : ""} ${selectedCategory === "Green_Packaging" ? "selected" : ""}`} onClick={() => setSelectedCategory("Green_Packaging")}>Eye Care</a>
                                        </li>
                                        <li>
                                            <a href="#" className={`btn ${selectedCategory === "Green_Packaging" ? "btn-secondary" : ""} ${selectedCategory === "Green_Packaging" ? "selected" : ""}`} onClick={() => setSelectedCategory("Green_Packaging")}>Hair Care</a>
                                        </li>
                                        <li>
                                            <a href="#" className={`btn ${selectedCategory === "Green_Packaging" ? "btn-secondary" : ""} ${selectedCategory === "Green_Packaging" ? "selected" : ""}`} onClick={() => setSelectedCategory("Green_Packaging")}>Lip Care</a>
                                        </li>
                                        <li>
                                            <a href="#" className={`btn ${selectedCategory === "Green_Packaging" ? "btn-secondary" : ""} ${selectedCategory === "Green_Packaging" ? "selected" : ""}`} onClick={() => setSelectedCategory("Green_Packaging")}>Green_Packaging</a>
                                        </li>
                                        <li>
                                            <a href="#" className={`btn ${selectedCategory === "Green_Packaging" ? "btn-secondary" : ""} ${selectedCategory === "Green_Packaging" ? "selected" : ""}`} onClick={() => setSelectedCategory("Green_Packaging")}>Green_Packaging</a>
                                        </li>
                                        <li>
                                            <a href="#" className={`btn ${selectedCategory === "Green_Packaging" ? "btn-secondary" : ""} ${selectedCategory === "Green_Packaging" ? "selected" : ""}`} onClick={() => setSelectedCategory("Green_Packaging")}>Skin Care</a>
                                        </li> */}
                                    </ul>
                                </div>
        ...
        <div className="col-12">
            <div className="text-center mt-4">
                <div className="d-none d-lg-block">
                    <h2 className="Shoppage_Heading1">Green Packaging</h2>
                </div>
                <div className="d-block d-lg-none">
                    <h2 className="Shoppage_Heading12">Green Packaging <button class="btn" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasScrolling" aria-controls="offcanvasScrolling">
