                            ...
                            <div className="col-12">
                                <div>
                                    ...
                                    <ul className="list-unstyled">
                                        ...
                                        <li>
                                            <a href="#" className={`btn ${selectedCategory === "stationery" ? "btn-secondary" : ""} ${selectedCategory === "stationery" ? "selected" : ""}`} onClick={() => setSelectedCategory("stationery")}>Stationery</a>
                                        </li>
                                        {/* <li>
                                            <a href="#" className={`btn ${selectedCategory === "stationery" ? "btn-secondary" : ""} ${selectedCategory === "stationery" ? "selected" : ""}`} onClick={() => setSelectedCategory("stationery")}>Essential Oils</a>
                                        </li>
                                        <li>
                                            <a href="#" className={`btn ${selectedCategory === "stationery" ? "btn-secondary" : ""} ${selectedCategory === "stationery" ? "selected" : ""}`} onClick={() => setSelectedCategory("stationery")}>Eye Care</a>
                                        </li>
                                        <li>
                                            <a href="#" className={`btn ${selectedCategory === "stationery" ? "btn-secondary" : ""} ${selectedCategory === "stationery" ? "selected" : ""}`} onClick={() => setSelectedCategory("stationery")}>Hair Care</a>
                                        </li>
                                        <li>
                                            <a href="#" className={`btn ${selectedCategory === "stationery" ? "btn-secondary" : ""} ${selectedCategory === "stationery" ? "selected" : ""}`} onClick={() => setSelectedCategory("stationery")}>Lip Care</a>
                                        </li>
                                        <li>
                                            <a href="#" className={`btn ${selectedCategory === "stationery" ? "btn-secondary" : ""} ${selectedCategory === "stationery" ? "selected" : ""}`} onClick={() => setSelectedCategory("stationery")}>stationery</a>
                                        </li>
                                        ...
                                        <li>
                                            <a href="#" className={`btn ${selectedCategory === "stationery" ? "btn-secondary" : ""} ${selectedCategory === "stationery" ? "selected" : ""}`} onClick={() => setSelectedCategory("stationery")}>Skin Care</a>
                                        </li> */}
                                    </ul>
                                </div>
        ...
        <div className="col-12">
            <div className="text-center mt-4">
                <div className="d-none d-lg-block">
                    <h2 className="Shoppage_Heading1">Stationery</h2>
                </div>
                <div className="d-block d-lg-none">
                    <h2 className="Shoppage_Heading12">Stationery <button class="btn" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasScrolling" aria-controls="offcanvasScrolling">
