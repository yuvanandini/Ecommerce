                            ...
                            <div className="col-12">
                                <div>
                                    ...
                                    <ul className="list-unstyled">
                                        ...
                                        <li>
                                            <a href="#" className={`btn ${selectedCategory === "immunity_booster" ? "btn-secondary" : ""} ${selectedCategory === "immunity_booster" ? "selected" : ""}`} onClick={() => setSelectedCategory("immunity_booster")}>Immunity Bbooster</a>
                                        </li>
                                        <li>
                                            <a href="#" className={`btn ${selectedCategory === "kid_accessories" ? "btn-secondary" : ""} ${selectedCategory === "kid_accessories" ? "selected" : ""}`} onClick={() => setSelectedCategory("kid_accessories")}>Kid Accessories</a>
                                        </li>
                                        <li>
                                            <a href="#" className={`btn ${selectedCategory === "baby_skin_care" ? "btn-secondary" : ""} ${selectedCategory === "baby_skin_care" ? "selected" : ""}`} onClick={() => setSelectedCategory("baby_skin_care")}>Baby Skin Care</a>
                                        </li>
                                        {/* <li>
                                            <a href="#" className={`btn ${selectedCategory === "baby_skin_care" ? "btn-secondary" : ""} ${selectedCategory === "baby_skin_care" ? "selected" : ""}`} onClick={() => setSelectedCategory("baby_skin_care")}>Hair Care</a>
                                        </li>
                                        <li>
                                            <a href="#" className={`btn ${selectedCategory === "baby_skin_care" ? "btn-secondary" : ""} ${selectedCategory === "baby_skin_care" ? "selected" : ""}`} onClick={() => setSelectedCategory("baby_skin_care")}>Lip Care</a>
                                        </li>
                                        <li>
                                            <a href="#" className={`btn ${selectedCategory === "kid_accessories" ? "btn-secondary" : ""} ${selectedCategory === "kid_accessories" ? "selected" : ""}`} onClick={() => setSelectedCategory("kid_accessories")}>Kid Accessories</a>
                                        </li>
                                        ...
                                        <div className="col-12">
                                            <div>
                                                ...
                                                <ul className="list-unstyled">
                                                    ...
                                                    <li>
                                                        <a href="#" className={`btn ${selectedCategory === "immunity_booster" ? "btn-secondary" : ""} ${selectedCategory === "immunity_booster" ? "selected" : ""}`} onClick={() => setSelectedCategory("immunity_booster")}>Immunity Booster</a>
                                                    </li>
                                                    <li>
                                                        <a href="#" className={`btn ${selectedCategory === "kid_accessories" ? "btn-secondary" : ""} ${selectedCategory === "kid_accessories" ? "selected" : ""}`} onClick={() => setSelectedCategory("kid_accessories")}>Kid Accessories</a>
                                                    </li>
                                                    ...
                                                    <li>
                                                        <a href="#" className={`btn ${selectedCategory === "kid_accessories" ? "btn-secondary" : ""} ${selectedCategory === "kid_accessories" ? "selected" : ""}`} onClick={() => setSelectedCategory("kid_accessories")}>kid_accessories</a>
                                                    </li>
                                                    <li>
                                                        <a href="#" className={`btn ${selectedCategory === "kid_accessories" ? "btn-secondary" : ""} ${selectedCategory === "kid_accessories" ? "selected" : ""}`} onClick={() => setSelectedCategory("kid_accessories")}>kid_accessories</a>
                                                    </li>
        ...
        <div className="col-12">
            <div className="text-center mt-4">
                <div className="d-none d-lg-block">
                    <h2 className="Shoppage_Heading1">Baby Care</h2>
                </div>
                <div className="d-block d-lg-none">
                    <h2 className="Shoppage_Heading12">Baby Care
