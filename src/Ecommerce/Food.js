  ...
  return (
    ...
    <h2>Select a category:</h2>
        <select value={selectedCategory} onChange={handleCategoryChange}>
            ...
            <option value="Diary Alternative">Diary Alternative</option>
            <option value="Dal Pulses">Dal Pulses</option>
            <option value="flour and sooji">Flour and Sooji</option>
            <option value="Grocery">Grocery</option>
            <option value="Health Sweetners">Health Sweeteners</option>
            <option value="Indian spices Masala">Indian Spices Masala</option>
            <option value="Mock Meat">Mock Meat</option>
            <option value="Oils">Oils</option>
            <option value="Quick Meals">Quick Meals</option>
            <option value="Rice Grains">Rice Grains</option>
            <option value="Sauces and others">Sauces and others</option>
        </select>
