...
import basicvichaarpdf from '../assets/Basic-Vichaar-by-EarthBased_1st_edition.pdf';
...
import bv1 from '../assets/first_edition/BV-01.png'
import bv2 from '../assets/first_edition/BV-02.png'
import bv3 from '../assets/first_edition/BV-03.png'
import bv4 from '../assets/first_edition/BV-04.png'
import bv5 from '../assets/first_edition/BV-05.png'
import bv6 from '../assets/first_edition/BV-06.png'
import bv7 from '../assets/first_edition/BV-07.png'
import bv8 from '../assets/first_edition/BV-08.png'
import bv9 from '../assets/first_edition/BV-09.png'
import bv10 from '../assets/first_edition/BV-10.png'
import bv11 from '../assets/first_edition/BV-11.png'
import bv12 from '../assets/first_edition/BV-12.png'
import bv13 from '../assets/first_edition/BV-13.png'
import bv14 from '../assets/first_edition/BV-14.png'
import bv15 from '../assets/first_edition/BV-15.png'
import bv16 from '../assets/first_edition/BV-16.png'
import bv17 from '../assets/first_edition/BV-17.png'
import bv18 from '../assets/first_edition/BV-18.png'
import bv19 from '../assets/first_edition/BV-19.png'
import bv20 from '../assets/first_edition/BV-20.png'
import bv21 from '../assets/first_edition/BV-21.png'
import bv22 from '../assets/first_edition/BV-22.png'
import bv23 from '../assets/first_edition/BV-23.png'
import bv24 from '../assets/first_edition/BV-24.png'
import bv25 from '../assets/first_edition/BV-25.png'
import bv26 from '../assets/first_edition/BV-26.png'
import bv27 from '../assets/first_edition/BV-27.png'
import bv28 from '../assets/first_edition/BV-28.png'
import bv29 from '../assets/first_edition/BV-29.png'
import bv30 from '../assets/first_edition/BV-30.png'
        ...
        <div className='container'>
          <div className='row d-flex flex-row justify-content-evenly'>
            <div className='col-lg-6 col-xs-12 col-sm-12 col-md-6 '>
              <div className='flipbook_section2'>
                <Flipbook width={300} height={400} ref={book} className='flip_book'>
                  <div><img src={bv1} alt="BV-1" className='img-fluid' /></div>
                  <div><img src={bv2} alt="BV-1" className='img-fluid' /></div>
                  <div><img src={bv3} alt="BV-1" className='img-fluid' /></div>
                  <div><img src={bv4} alt="BV-1" className='img-fluid' /></div>
                  <div><img src={bv5} alt="BV-1" className='img-fluid' /></div>
                  <div><img src={bv6} alt="BV-1" className='img-fluid' /></div>
                  <div><img src={bv7} alt="BV-1" className='img-fluid' /></div>
                  <div><img src={bv8} alt="BV-1" className='img-fluid' /></div>
                  <div><img src={bv9} alt="BV-1" className='img-fluid' /></div>
                  <div><img src={bv10} alt="BV-1" className='img-fluid' /></div>
                  <div><img src={bv11} alt="BV-1" className='img-fluid' /></div>
                  <div><img src={bv12} alt="BV-1" className='img-fluid' /></div>
                  <div><img src={bv13} alt="BV-1" className='img-fluid' /></div>
                  <div><img src={bv14} alt="BV-1" className='img-fluid' /></div>
                  <div><img src={bv15} alt="BV-1" className='img-fluid' /></div>
                  <div><img src={bv16} alt="BV-1" className='img-fluid' /></div>
                  <div><img src={bv17} alt="BV-1" className='img-fluid' /></div>
                  <div><img src={bv18} alt="BV-1" className='img-fluid' /></div>
                  <div><img src={bv19} alt="BV-1" className='img-fluid' /></div>
                  <div><img src={bv20} alt="BV-1" className='img-fluid' /></div>
                  <div><img src={bv21} alt="BV-1" className='img-fluid' /></div>
                  <div><img src={bv22} alt="BV-1" className='img-fluid' /></div>
                  <div><img src={bv23} alt="BV-1" className='img-fluid' /></div>
                  <div><img src={bv24} alt="BV-1" className='img-fluid' /></div>
                  <div><img src={bv25} alt="BV-1" className='img-fluid' /></div>
                  <div><img src={bv26} alt="BV-1" className='img-fluid' /></div>
                  <div><img src={bv27} alt="BV-1" className='img-fluid' /></div>
                  <div><img src={bv28} alt="BV-1" className='img-fluid' /></div>
                  <div><img src={bv29} alt="BV-1" className='img-fluid' /></div>
                  <div><img src={bv30} alt="BV-1" className='img-fluid' /></div>

                  <div></div>
                  <div></div>
                </Flipbook>
                <div className='text-center flip_buttons buttons_flip '  style={{ marginTop: '5px' }}>
                  <button onClick={() =>
              ...
              <div className='row justify-content-evenly mt-4'>
                ...
                <div className='col-lg-3 pt-1  download_button shadow '  style={{ height: '40px' }} >
                ...
                <div class="col-lg-3 pt-1 share-buttons"   style={{ height: '40px' }}>
                  <button id="shareButton" className="share-main-button" style={{backgroundColor:'#F6F1DD'}}>
                    <svg
                      width="20"
                      height="20"
                      fill="currentColor"
                ...
                {/* <div className='col-lg-4 pt-1 download_button' onClick={togglePlay}>
            ...
            <div className='col-lg-5 col-xs-12 col-sm-12 col-md-6 flip_content_text d-flex flex-column justify-content-center'>
              <h3 className='basic_heading mt-4' style={{}}>2nd Edition- Basic Vichaar</h3>
              ...
              <p>
                We explore how conscious consumer choices, such as opting for eco-friendly products and supporting ethical brands, can make a significant impact on the environment. Join us on this enlightening journey towards a sustainable future, where every choice we make counts. </p>

              <div style={{ textAlign: 'center' }}>
                <button variant="success" className='mt-3 first_edition'  ><a href="/basic-vichaar" style={{ textDecoration: 'none', color: 'inherit' }}>1st Edition </a>
